...
from kafkautils.handlers import (
    lusha_company_collection_handler,
    ...
    leadgen_csv_import_processing_handler,
    leadgen_company_qualification_ai_processing_handler,
    leadgen_contact_qualification_ai_processing_handler,
    ...
    LeadgenServices.leadgen: {  # Service level grouping (like Vector)
        "leadgen_batch_consumer": {
            ...
            "topics_configurations": {
                ...
                KAFKA_SERVICE_CONFIG_MAPPING[LeadgenServices.leadgen][LEADGEN_CSV_IMPORT_PROCESSING]["topics"][0]: {
                    "tasks": [leadgen_csv_import_processing_handler]
                },
                ...
                KAFKA_SERVICE_CONFIG_MAPPING[LeadgenServices.leadgen][LEADGEN_CONTACT_QUALIFICATION_AI_PROCESSING]["topics"][0]: {
                    "tasks": [leadgen_contact_qualification_ai_processing_handler]
                },
                ...
                KAFKA_SERVICE_CONFIG_MAPPING[LeadgenServices.leadgen][LEADGEN_HUBSPOT_SYNC_PROCESSING]["topics"][0]: {
                    "tasks": [leadgen_hubspot_sync_processing_handler]
                },
