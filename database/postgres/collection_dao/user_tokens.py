"""PostgreSQL User Tokens DAO for authentication."""
...
from database.postgres.models import UserToken

logger = logging.getLogger(__name__)


class PostgresUserTokensDao(BasePostgresDao):
    """PostgreSQL Data Access Object for user_tokens table."""
    ...
    async def create_token(self, user_id: str, token: str, expires_at: datetime) -> str:
